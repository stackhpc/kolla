...
Then the :command:`kolla-build` command is responsible for building Docker
images.
...
or with the file you find in the ``etc_examples`` folder of the Kolla pip
package.  But you should only do that for testing purposes, if at all.
